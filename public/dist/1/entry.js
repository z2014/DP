...
var _matchesType = __webpack_require__(51);
...
var _checkDecoratorArguments = __webpack_require__(24);
...
var _dragDrop = __webpack_require__(16);
...
var baseDifference = __webpack_require__(53),
...
var _xor = __webpack_require__(137);

var _xor2 = _interopRequireDefault(_xor);

var _intersection = __webpack_require__(145);

var _intersection2 = _interopRequireDefault(_intersection);

var _dragDrop = __webpack_require__(16);

var _registry = __webpack_require__(23);
...
var SetCache = __webpack_require__(29),
    ...
    arrayIncludesWith = __webpack_require__(31),
    cacheHas = __webpack_require__(34),
    createSet = __webpack_require__(143),
...
var _shallowEqualScalar = __webpack_require__(66);
...
var _cloneWithRef = __webpack_require__(168);
...
var _memoize = __webpack_require__(197);
...
var _DragDropContext = __webpack_require__(48);
...
var _DragDropContextProvider = __webpack_require__(157);
...
var _DragLayer = __webpack_require__(158);
...
var _DragSource = __webpack_require__(159);
...
var _reactDndHtml5Backend = __webpack_require__(174);
            ...
            if (children.com.component_name === 'text') {
                return function (ctx) {
                    __webpack_require__.e/* require.ensure */(8).then((function (require) {
                        ctx.state.com = __webpack_require__(204);
                        ctx.setState({});
            ...
            if (children.com.component_name === 'pieChart') {
                return function (ctx) {
                    __webpack_require__.e/* require.ensure */(0).then((function (require) {
                        ctx.state.com = __webpack_require__(205);
                        ctx.setState({});
                    }).bind(null, __webpack_require__)).catch(__webpack_require__.oe);
                };
            }
            ...
            if (children.com.component_name === 'barChart') {
                return function (ctx) {
                    __webpack_require__.e/* require.ensure */(4).then((function (require) {
                        ctx.state.com = __webpack_require__(206);
                        ctx.setState({});
                    }).bind(null, __webpack_require__)).catch(__webpack_require__.oe);
                };
            }
            ...
            if (children.com.component_name === 'lineChart') {
                return function (ctx) {
                    __webpack_require__.e/* require.ensure */(1).then((function (require) {
                        ctx.state.com = __webpack_require__(207);
                        ctx.setState({});
                    }).bind(null, __webpack_require__)).catch(__webpack_require__.oe);
                };
            }
            ...
            if (children.com.component_name === 'mapChart') {
                return function (ctx) {
                    __webpack_require__.e/* require.ensure */(3).then((function (require) {
                        ctx.state.com = __webpack_require__(208);
                        ctx.setState({});
                    }).bind(null, __webpack_require__)).catch(__webpack_require__.oe);
                };
            }
            ...
            if (children.com.component_name === 'funnelChart') {
                return function (ctx) {
                    __webpack_require__.e/* require.ensure */(2).then((function (require) {
                        ctx.state.com = __webpack_require__(209);
                        ctx.setState({});
                    }).bind(null, __webpack_require__)).catch(__webpack_require__.oe);
                };
            }
            ...
            if (children.com.component_name === 'link') {
                return function (ctx) {
                    __webpack_require__.e/* require.ensure */(10).then((function (require) {
                        ctx.state.com = __webpack_require__(210);
                        ctx.setState({});
                    }).bind(null, __webpack_require__)).catch(__webpack_require__.oe);
                };
            }
            ...
            if (children.com.component_name === 'sidebar') {
                return function (ctx) {
                    __webpack_require__.e/* require.ensure */(5).then((function (require) {
                        ctx.state.com = __webpack_require__(211);
                        ctx.setState({});
                    }).bind(null, __webpack_require__)).catch(__webpack_require__.oe);
                };
            }
            ...
            if (children.com.component_name === 'datePicker') {
                return function (ctx) {
                    __webpack_require__.e/* require.ensure */(11).then((function (require) {
                        ctx.state.com = __webpack_require__(212);
                        ctx.setState({});
                    }).bind(null, __webpack_require__)).catch(__webpack_require__.oe);
                };
            }
            ...
            if (children.com.component_name === 'searchInput') {
                return function (ctx) {
                    __webpack_require__.e/* require.ensure */(6).then((function (require) {
                        ctx.state.com = __webpack_require__(213);
                        ctx.setState({});
                    }).bind(null, __webpack_require__)).catch(__webpack_require__.oe);
                };
            }
            ...
            if (children.com.component_name === 'affix') {
                return function (ctx) {
                    __webpack_require__.e/* require.ensure */(7).then((function (require) {
                        ctx.state.com = __webpack_require__(216);
                        ctx.setState({});
                    }).bind(null, __webpack_require__)).catch(__webpack_require__.oe);
                };
            }
...
var App = (_dec = (0, _reactDnd.DragDropContext)(_reactDndHtml5Backend2.default), _dec(_class = function (_React$Component2) {
    ...
    _createClass(App, [{
        key: 'render',
        value: function render() {
            var test = JSON.parse(components);
            var coms = test.map(function (com, index) {
...
var _DragSource = __webpack_require__(154);
...
var _DropTarget = __webpack_require__(155);
...
var _createTestBackend = __webpack_require__(156);
...
var _DragDropMonitor = __webpack_require__(149);
...
/* WEBPACK VAR INJECTION */}.call(__webpack_exports__, __webpack_require__(25), __webpack_require__(97)(module)))
...
var _dragOffset = __webpack_require__(50);

var _dragOffset2 = _interopRequireDefault(_dragOffset);

var _dragOperation = __webpack_require__(100);

var _dragOperation2 = _interopRequireDefault(_dragOperation);

var _refCount = __webpack_require__(136);

var _refCount2 = _interopRequireDefault(_refCount);

var _dirtyHandlerIds = __webpack_require__(60);

var _dirtyHandlerIds2 = _interopRequireDefault(_dirtyHandlerIds);

var _stateId = __webpack_require__(148);
...
var baseFindIndex = __webpack_require__(128),
    ...
    strictIndexOf = __webpack_require__(130);
...
var arrayFilter = __webpack_require__(138),
    baseRest = __webpack_require__(6),
    baseXor = __webpack_require__(139),
    isArrayLikeObject = __webpack_require__(22);
...
var arrayMap = __webpack_require__(32),
    ...
    baseRest = __webpack_require__(6),
    castArrayLikeObject = __webpack_require__(147);
...
var isArrayLikeObject = __webpack_require__(22);
...
var _HandlerRegistry = __webpack_require__(150);
...
var _asap = __webpack_require__(151);

var _asap2 = _interopRequireDefault(_asap);

var _registry = __webpack_require__(23);

var _getNextUniqueId = __webpack_require__(153);
...
var rawAsap = __webpack_require__(152);
...
var _noop = __webpack_require__(64);
...
var _registerSource = __webpack_require__(164);

var _registerSource2 = _interopRequireDefault(_registerSource);

var _createSourceFactory = __webpack_require__(165);

var _createSourceFactory2 = _interopRequireDefault(_createSourceFactory);

var _createSourceMonitor = __webpack_require__(166);

var _createSourceMonitor2 = _interopRequireDefault(_createSourceMonitor);

var _createSourceConnector = __webpack_require__(167);

var _createSourceConnector2 = _interopRequireDefault(_createSourceConnector);

var _isValidType = __webpack_require__(70);
...
var _isDisposable = __webpack_require__(38);
...
var _wrapConnectorHooks = __webpack_require__(68);

var _wrapConnectorHooks2 = _interopRequireDefault(_wrapConnectorHooks);

var _areOptionsEqual = __webpack_require__(69);
...
var _registerTarget = __webpack_require__(170);

var _registerTarget2 = _interopRequireDefault(_registerTarget);

var _createTargetFactory = __webpack_require__(171);

var _createTargetFactory2 = _interopRequireDefault(_createTargetFactory);

var _createTargetMonitor = __webpack_require__(172);
...
var _HTML5Backend = __webpack_require__(175);

var _HTML5Backend2 = _interopRequireDefault(_HTML5Backend);

var _getEmptyImage = __webpack_require__(201);

var _getEmptyImage2 = _interopRequireDefault(_getEmptyImage);

var _NativeTypes = __webpack_require__(39);
...
var _defaults = __webpack_require__(176);
...
var _BrowserDetector = __webpack_require__(73);

var _OffsetUtils = __webpack_require__(198);

var _NativeDragSources = __webpack_require__(200);
...
var apply = __webpack_require__(57),
    assignInWith = __webpack_require__(177),
    baseRest = __webpack_require__(6),
...
var arrayLikeKeys = __webpack_require__(183),
    baseKeysIn = __webpack_require__(190),
    isArrayLike = __webpack_require__(35);
...
var _union = __webpack_require__(196);
...
var _MonotonicInterpolant = __webpack_require__(199);
